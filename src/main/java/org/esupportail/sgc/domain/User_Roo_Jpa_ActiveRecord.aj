...
privileged aspect User_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> User.fieldNames4OrderClauseFilter = java.util.Arrays.asList("log", "DUE_DATE_INCLUDED_DELAY", "BOOLEAN_FIELDS", "eppn", "cards", "crous", "crousError", "europeanStudentCard", "difPhoto", "name", "firstname", "birthday", "institute", "eduPersonPrimaryAffiliation", "email", "rneEtablissement", "cnousReferenceStatut", "indice", "dueDate", "idCompagnyRate", "idRate", "supannEmpId", "supannEtuId", "supannEntiteAffectationPrincipale", "supannCodeINE", "secondaryId", "recto1", "recto2", "recto3", "recto4", "recto5", "recto6", "recto7", "verso1", "verso2", "verso3", "verso4", "verso5", "verso6", "verso7", "editable", "requestFree", "address", "externalAddress", "freeField1", "freeField2", "freeField3", "nbCards", "userType", "templateKey", "lastCardTemplatePrinted", "roles", "externalCard", "blockUserMsg", "hasCardRequestPending", "academicLevel", "importExtCardRight", "newCardRight", "viewRight");
