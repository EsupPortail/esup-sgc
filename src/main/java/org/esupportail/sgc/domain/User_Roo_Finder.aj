...
privileged aspect User_Roo_Finder {
    ...
    public static Long User.countFindUsersByCrous(Boolean crous) {
    ...
    public static TypedQuery<User> User.findUsersByCrous(Boolean crous, String sortFieldName, String sortOrder) {
        if (crous == null) throw new IllegalArgumentException("The crous argument is required");
        EntityManager em = User.entityManager();
        StringBuilder queryBuilder = new StringBuilder("SELECT o FROM User AS o WHERE o.crous = :crous");
