...
privileged aspect Log_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Log.fieldNames4OrderClauseFilter = java.util.Arrays.asList("logDate", "eppn", "eppnCible", "type", "cardId", "action", "retCode", "comment", "remoteAddress");
