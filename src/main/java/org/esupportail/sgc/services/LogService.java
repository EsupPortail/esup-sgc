...
public class LogService {
	...
	public static enum ACTION {
		ETAT, DEMANDE, DISABLED, ENABLED, PAYMENT, UPDATEPHOTO, DIFPHOTO, FORCEDUPDATE, MAJVERSO, FORCEDFREEREQUEST, CROUS_DESACTIVATION, CROUS_PATCH_IDENTIFIER, USER_DELIVERY, UPDATEPREFS, ENABLECROUS
