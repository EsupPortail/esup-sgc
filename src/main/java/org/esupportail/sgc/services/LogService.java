...
public class LogService {
	...
	public static enum ACTION {
		...
		CROUS_DESACTIVATION, CROUS_PATCH_IDENTIFIER, USER_DELIVERY, UPDATEPREFS, ENABLECROUS, ENABLEEUROPEANCARD, RENEWAL, 
		MANAGER_DELIVERY, REQUEST_FROM_LDAP, RETOUCHE_PHOTO, RETOUCHE_ACTION_IND, PURGE_USER, PURGE_CARD, REQUEST_MANAGER, DISABLECROUS
