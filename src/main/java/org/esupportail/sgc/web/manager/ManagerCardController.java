...
import org.esupportail.sgc.web.manager.custom.ColumnConfigurationService;
...
public class ManagerCardController {
	...
	public Map getuserPrefs() {
		...
		mapPrefs.put("editable", preferencesService.getPrefValue(eppn, Prefs.PrefKey.EDITABLE));
		mapPrefs.put("ownOrFreeCard", preferencesService.getPrefValue(eppn, Prefs.PrefKey.OWNORFREECARD));
		mapPrefs.put("userType", preferencesService.getPrefValue(eppn, Prefs.PrefKey.USERTYPE));
		stopWatch.stop();
	...
	public String search(@RequestParam Map<String, String> params,
		...
		if (index != null && "first".equals(index)) {
			searchBean.setEditable(preferencesService.getPrefValue(eppn, Prefs.PrefKey.EDITABLE));
			searchBean.setOwnOrFreeCard(Boolean.valueOf(preferencesService.getPrefValue(eppn, Prefs.PrefKey.OWNORFREECARD)));
			String userTypePref = preferencesService.getPrefValue(eppn, Prefs.PrefKey.USERTYPE);
	...
	public String savePrefs(@RequestParam(value = "editable", required = false) String editable,
		...
		try {
			preferencesService.setPrefs(eppn, Prefs.PrefKey.EDITABLE, editable);
			preferencesService.setPrefs(eppn, Prefs.PrefKey.OWNORFREECARD, ownOrFreeCard);
			preferencesService.setPrefs(eppn, Prefs.PrefKey.USERTYPE, userType);
		} catch (Exception e) {
